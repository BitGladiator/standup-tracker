...
const Visualizer = ({ analyserData, playing, phase }) => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < BAR_COUNT; i++) {
      ...
      const barH = playing ? Math.max(2, (value / 255) * H * 0.9) : 2;
      const x = i * (barW + 1);
      const y = H - barH;
...
const AudioPlayer = ({ phase, audioEngine }) => {
  ...
  const phaseColor =
    phase === "work" ? "#3182CE" : phase === "break" ? "#38A169" : "#718096";
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div
            style={{ fontSize: "13px", fontWeight: "600", color: "#2d3748" }}
          >
            Focus sounds
          </div>
          <div
            style={{ fontSize: "11px", color: phaseColor, marginTop: "2px" }}
          >
            {phaseLabel}
          </div>
        </div>
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "6px",
              cursor:
                (!isActive && !playing) || loading ? "not-allowed" : "pointer",
